...
def format_data(data):
    ...
    dataframes = [pd.DataFrame.from_dict(band) for band in data if band["mag"] is not None]
    ...
    for filter in filters:
        ...
        combined_data.loc[combined_data["band"] == filter, "mag"] += med_first_filter - med_filtered
